    ...
    <v-row>
      ...
      <v-column col="7" >
        <div >
          ...
          <p class="text-primary-light-1 text-5 mt-1 font-700 ">Veggi Fun Pizza</p>
          ...
          <NuxtLink class="btn btn-primary mt-2" :to="{name:'PRODUCT_DETAIL',params:{link:'spicy-pepperoni'}}">
            order now
          </NuxtLink>
        </div>
      </v-column>

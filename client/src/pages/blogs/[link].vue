    ...
    <div class="blog-detail">
      ...
      <div class="flex items-center" >
        <p class="font-500 capitalize text-primary-light-3 text-1">
          By: {{blog_data.author_firstname}} {{blog_data.author_lastname}}
        </p>
...
<!--      ////// start comments render here-->
      <template v-if="!blog_comments_flag && blog_data.total_comments>0">
        <h3 class="mb-1 capitalize">comments {{blog_data.total_comments}}</h3>
        <BlogComment
...
<!--      //// in case of no comments-->
      <h3 v-else-if="blog_data.total_comments===0" class="mb-1 capitalize">no comments.</h3>
